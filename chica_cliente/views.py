    ...
    if request.user.is_authenticated():
        ...
        if empresa == 'chicadiniz':
            if request.method == 'POST' and request.POST.get('nome') != None:
                ...
                return render(request, 'chica_cliente/cliente_novo.html', {'title':'Novo Cliente', 'msg':msg})
            return render(request, 'chica_cliente/cliente_novo.html', {'title':'Novo Cliente'})
